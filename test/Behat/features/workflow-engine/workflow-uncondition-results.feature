Feature:UnConditions Result


    Scenario: Test unconditions result. Test uncondition pre and post function.
...
<workflow>
  ...
  """
        ...
        Then Process of workflow with the alias "test" has the below steps:
            ...
            And There is the valuable "preFunctions" with value "preFunction_4" in Transient Vars
            And There is the valuable "postFunctions" with value "postFunction_4" in Transient Vars
